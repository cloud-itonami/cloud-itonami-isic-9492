# Operator Quickstart — Activities of political organizations

Shortest path from clone to a verified local dry-run for **ISIC 9492** (`cloud-itonami-isic-9492`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9492.git
cd cloud-itonami-isic-9492
```
...
- Blueprint governor key: `political-organization-governance-governor`
- Likely source path: `partyops.governor.cljc`
